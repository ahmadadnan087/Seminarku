...
class HistoryPosting extends StatefulWidget {
...
class _Riwayat extends State < HistoryPosting > with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Riwayat Posting Seminar',
          style: TextStyle(
            fontSize: 20.0,
